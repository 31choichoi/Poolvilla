...
export default function AdminDashboard({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  const ROOM_COLORS: Record<string, string> = {
    ...
    "Room 201": "bg-amber-50 text-amber-700 border-amber-100 hover:bg-amber-100",
    "Room 202": "bg-rose-50 text-rose-700 border-rose-100 hover:bg-rose-100",
    "VIP Suite": "bg-violet-50 text-violet-700 border-violet-100 hover:bg-violet-100",
  };
